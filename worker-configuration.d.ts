/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b27701613b360a4dc3b2b30262da8283)
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'R2_ACCOUNT_ID' | 'R2_ACCESS_KEY_ID' | 'R2_SECRET_ACCESS_KEY' | 'R2_BUCKET_NAME' | 'BEARER_TOKEN'
      >
    > {}
}
