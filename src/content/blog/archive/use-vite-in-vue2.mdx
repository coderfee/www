...
![vite-dev.png](https://assets.coderfee.com/blog/posts/vite-dev.png)

而 Vue CLI 生成 Webpack 项目的运行时间如下，大概在 3s 左右：

![vue-serve.png](https://assets.coderfee.com/blog/posts/vue-serve.png)
...
![vuecli-in-action.png](https://assets.coderfee.com/blog/posts/vuecli-in-action.png)

使用 Vite 之后启动只需要 1-2s 左右：

![vite-in-action.png](https://assets.coderfee.com/blog/posts/vite-in-action.png)
