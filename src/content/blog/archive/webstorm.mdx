...
![webstorm-shot.png](https://assets.coderfee.com/blog/posts/webstorm-shot.png)
...
![disabled-plugins.png](https://assets.coderfee.com/blog/posts/disabled-plugins.png)
...
![change-memory.png](https://assets.coderfee.com/blog/posts/change-memory.png)
...
![key-promoter-x.png](https://assets.coderfee.com/blog/posts/key-promoter-x.png)

当然这么多快捷键肯定是记不下的，那就只能用到什么查什么了，WebStorm 自带了快捷键文档，打开 `Help → Keyboard Shortcuts PDF` 就可以查看：

![keyboard-shortcuts.png](https://assets.coderfee.com/blog/posts/keyboard-shortcuts.png)
...
![setting-sync.png](https://assets.coderfee.com/blog/posts/setting-sync.png)

## 正版 Or 盗版

条件允许的情况下还是支持正版吧。上大学期间用的是网上的注册码，后来工作直接买了 JetBrains 全家桶，不用再为 License 发愁了，省时省力。第一年 249 刀，后续每年都有折扣，看个人情况。

![billing.png](https://assets.coderfee.com/blog/posts/billing.png)
